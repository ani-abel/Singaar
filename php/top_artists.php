...
<head>
    ...
    <title>Top Artists | Singaar</title>
...
<div class="section section-pg-content">
    <div class="row">
        ...
        <div class="col s12 m12 l8 blog-post-con">
            <div class="row">
                <div class="col s12">
                    <div class="card">
                        <div class="card-content">
                            <span class="card-title">Top 10 Artists</span>
                            <table class="striped responsive-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="blue-text text-darken-2">1</td>
                                        <td width="70">
                                        ...
                                        <td>Post Malone</td>
                                        <td>December, 2017</td>
                                        <td><i class="fa fa-caret-down red-text text-darken-3"></i></td>
                                        <td>
                                            <a href="artist_interview_detail.php" class="btn blue lighten-2">
                                    ...
                                    <tr>
                                        <td class="blue-text text-darken-2">2</td>
                                        <td width="70">
                                            <img src="../images/person1.jpg"
                                                 style="width: 40px;margin-left: 10px;"
                                                 alt="Image" class="responsive-img circle"/>
                                        ...
                                        <td>Post Malone</td>
                                        <td>December, 2017</td>
                                        <td><i class="fa fa-caret-up green-text text-darken-3"></i></td>
                                        <td>
                                            <a href="artist_interview_detail.php" class="btn blue lighten-2">
                                                <i class="fa fa-music"></i>
                                                <span class="hide-on-small-only">
                                    ...
                                    <tr>
                                        <td class="blue-text text-darken-2">3</td>
                                        <td width="70">
                                            <img src="../images/person1.jpg"
                                                 style="width: 40px;margin-left: 10px;"
                                                 alt="Image" class="responsive-img circle"/>
                                    ...
                                    <tr>
                                        <td class="blue-text text-darken-2">4</td>
                                        <td width="70">
                                            <img src="../images/person1.jpg"
                                                 style="width: 40px;margin-left: 10px;"
                                                 alt="Image" class="responsive-img circle"/>
                                    ...
                                    <tr>
                                        <td class="blue-text text-darken-2">5</td>
                                        <td width="70">
                                            <img src="../images/person1.jpg"
                                                 style="width: 40px;margin-left: 10px;"
                                                 alt="Image" class="responsive-img circle"/>
                                    ...
                                    <tr>
                                        <td class="blue-text text-darken-2">6</td>
                                        <td width="70">
                                            <img src="../images/person1.jpg"
                                                 style="width: 40px;margin-left: 10px;"
                                                 alt="Image" class="responsive-img circle"/>
                                    ...
                                    <tr>
                                        <td class="blue-text text-darken-2">7</td>
                                        <td width="70">
                                            <img src="../images/person1.jpg"
                                                 style="width: 40px;margin-left: 10px;"
                                                 alt="Image" class="responsive-img circle"/>
                                    ...
                                    <tr>
                                        <td class="blue-text text-darken-2">8</td>
                                        <td width="70">
                                            <img src="../images/person1.jpg"
                                                 style="width: 40px;margin-left: 10px;"
                                                 alt="Image" class="responsive-img circle"/>
                                    ...
                                    <tr>
                                        <td class="blue-text text-darken-2">9</td>
                                        <td width="70">
                                            <img src="../images/person1.jpg"
                                                 style="width: 40px;margin-left: 10px;"
                                                 alt="Image" class="responsive-img circle"/>
                                    ...
                                    <tr>
                                        <td class="blue-text text-darken-2">10</td>
                                        <td width="70">
                                            <img src="../images/person1.jpg"
                                                 style="width: 40px;margin-left: 10px;"
                                                 alt="Image" class="responsive-img circle"/>
