...
<head>
    ...
    <title>Music : All Songs | Singaar</title>
...
<div class="section section-pg-content">
    <div class="row">
        ...
        <div class="col s12 m12 l8 music-widget">
            <div class="row">
                <!--section: music-widgets-->
                <div class="col s12 m6">
                    <div class="card">
                        <div class="card-content">
                            <h5 class="flow-text text-capitalize">
                                <i class="fa fa-music"></i> Post Malone ft ty dollar sign - psycho
                            </h5>
                        </div>
                        <div class="card-action blue darken-3 white-text">
                            <a href=""
                               ...
                               class="btn blue darken-2 waves-effect waves-ripple tooltipped">
                               <i class="fa fa-download"></i>
                            </a>
                            <a href="../artist_account/public_page_audio.php?a_id="
                               data-position="top"
                               data-tooltip="Play"
                               target="_blank"
                               class="btn red lighten-1 waves-effect waves-ripple tooltipped">
                                <i class="fa fa-play-circle-o"></i> <span class="hide-on-med-and-down">Play</span>
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <ul class="tabs">
                            <li class="tab col s6">
                                <a href="#tab1" class="blue-text text-darken-2"
                                   style="font-size: 16px !important;">Popular Songs</a>
                            </li>
                            <li class="tab col s6">
                                <a href="#tab2" class="blue-text text-darken-2"
                                   style="font-size: 16px !important;">Older Songs</a>
                            </li>
                        </ul>
                    </div>
                                    ...
                                    <td>
                                        <a href="./blog_single.php">
                                            ...
                                            <span class="grey-text">
                                                <a href="" class="btn blue darken-2 waves-effect waves-ripple">
                                                    Download
                                                </a>
                                            </span>
                                        </a>
