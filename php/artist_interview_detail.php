...
<head>
    ...
    <title>Featured Artist Interview | Post Malone</title>
                ...
                <div class="col s12">
                    <div class="card">
                        <div class="card-content">
                            <span class="card-title text-capitalize">Post Malone</span>
                            <span class="grey-text"><i class="fa fa-calendar"></i> December, 2019</span><br><br>
