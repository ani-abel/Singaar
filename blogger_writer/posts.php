    ...
    <div class="container">
        <div class="row">
            <div class="col s12">
                <?php
                    $limit = getSqlOffsets();
                    $post_array = BlogWriter::getAllPosts($limit["st_limit"], $limit["end_limit"]);
                ...
                <div class="card">
                    ...
                    <div class="card-action">
                        <ul class="pagination">
                            <?php
                                $rs = $db->query(SEL_ALL." blog_posts WHERE(written_by='{$session->user_id}')");
