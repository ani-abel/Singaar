...
<head>
    <meta charset="UTF-8">
    <title>Manage::<?php echo ucwords($post_title); ?> | Singaar</title>
                    ...
                    <div class="card-content">
                        ...
                        <form action="" id="form">
                            <div class="input-field">
                                <input type="text" id="title" required name="post_title" maxlength="300"
                            ...
                            <div class="input-field">
                                <textarea name="body" required id="body" class="materialize-textarea">
                                    <?php echo $post_body; ?>
                                </textarea>
