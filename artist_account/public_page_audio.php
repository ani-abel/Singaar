...
<head>
    <meta charset="UTF-8">
    <title> Song: Jimmy Hendrix - Slay the dragon | Post Malone's Public Page</title>
        ...
        <div class="col s12 m8 offset-m2 l6 offset-l3">
            <div class="card blue darken-2 white-text">
                <div class="card-content">
                    <div class="row">
                        ...
                        <div class="col s12" style="margin-top: 10px;">
                            <audio controls preload="metadata" autoplay style="width:100%;">
                                <source
                                    src="../images/10.%20Ooh%20Ft.%20Christianne%20Jensen.mp3" type="audio/mp3"/>
                            </audio>
                        </div>
                    </div>
                ...
                <div class="card-action valign-wrapper">
                    <div class="row">
                        <div class="col s6">
                            <a href="./public_page_audio.php?a_id="
                               data-position="top"
