...
<head>
    <meta charset="UTF-8">
    <title>Fan Mail | <?php echo ucwords($artist_info_node["username"]); ?></title>
    ...
    <style>
        ...
        .t-area, #reply-to, #reply-email{ border-bottom-color: white !important; }

        .t-area::selection, #reply-to::selection, #reply-email::selection{ background: coral !important; }

        .t-area::-moz-selection, #reply-to::-moz-selection, #reply-email::-moz-selection{ background: coral !important; }
                                    ...
                                    <div class="collapsible-body no-padding">
                                        <div class="row">
                                            ...
                                            <div class="col s12 replies-widget grey lighten-5">
                                                <h6 class="salutation text-capitalize blue-text text-darken-2">
                                                    Hi Jaime,
                                                </h6>
                                                <p>
                                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur cupiditate dolor dolorum enim iusto praesentium quod saepe voluptate. Illum, quisquam?
                                                </p>
                                            </div>
                                            <!--Widgets for replies from singaar team begins here-->
                                            <div class="col s12 replies-widget grey lighten-5">
                                                <h6 class="salutation text-uppercase blue-text text-darken-2">
                                                    <i class="fa fa-list"></i> Shehu's contact info
                                                </h6>
                                                <ul>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <span class="blue-text text-darken-3">
                                                            <i class="fa fa-envelope-o"></i> Email:</span>
                                                        shehu440@gmail.com
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="col s12 no-padding replies-widget replies-widget-last">
                                                <button class="red darken-2 btn waves-effect waves-ripple">
                ...
                <div class="card-action blue darken-2 white-text center message-action">
                    <form action="" method="post">
                        <div class="input-field">
                            <i class="prefix fa fa-user-circle-o white-text"></i>
                            <input type="text" id="reply-to" required style="border-bottom-color: #fff;"/>
                            <label for="reply-to" class="white-text">Message to</label>
                        </div>
                        <div class="input-field">
                            <i class="prefix fa fa-envelope-o white-text"></i>
                            <input type="text" id="reply-email" required style="border-bottom-color: #fff;"/>
                            <label for="reply-email" class="white-text">Email</label>
                        </div>
                        <div class="input-field">
                            ...
                            <label for="write-msg" class="white-text">Message...</label>
                        </div>
